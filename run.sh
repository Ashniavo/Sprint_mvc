...
# 2. Copier le .jar dans le dossier lib/ a la racine du projet
mkdir -p lib
cp target/sprint0-lib.jar lib/sprint0.jar
echo "✅ sprint0.jar copie dans lib/sprint0.jar"
...
echo ""
echo "=== ✅ Projet lance ! ==="
ls -lh lib/sprint0.jar
ls -lh target/sprint0.war
echo ">>> Ouvre : http://localhost:8080/sprint0/dept/new"